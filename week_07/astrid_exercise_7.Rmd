...
# size = Output shape
np.random.seed(7)
random_vector = np.random.normal(loc=0, scale=5, size=60)
y_noisy = y + random_vector
len(y_noisy) #@Why is the len 60? Whould it not be 120 when adding two vectors of len 60?
```
**Rating: i** 
**I am guessing at the size of the random_vector**
###1.1.iii. 
