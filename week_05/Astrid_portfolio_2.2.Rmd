...
#@ why tf will it not run if the nullmodel is the first one in the string????? #Lau says the function fits how to analyse based on the first model (nullmodel is glm the rest is glmer) so it gets fuked uup
