...
# Just need to figure out the matrix(c(0, 0, 0, 0, 0, 1, 0, 0) thing is EXERCISE 6 
...
fit.pas1 <- optim.sub7.pas1$par[1] + ((optim.sub7.pas1$par[2]-optim.sub7.pas1$par[1]) / (1+exp(1)*((optim.sub7.pas1$par[3]-sub7.pas1$x)/(optim.sub7.pas1$par[4]))))

fit.pas2 <- optim.sub7.pas2$par[1] + ((optim.sub7.pas2$par[2]-optim.sub7.pas2$par[1]) / (1+exp(1)*((optim.sub7.pas2$par[3]-sub7.pas2$x)/(optim.sub7.pas2$par[4]))))

fit.pas3 <- optim.sub7.pas3$par[1] + ((optim.sub7.pas3$par[2]-optim.sub7.pas3$par[1]) / (1+exp(1)*((optim.sub7.pas3$par[3]-sub7.pas3$x)/(optim.sub7.pas3$par[4]))))

fit.pas4 <- optim.sub7.pas4$par[1] + ((optim.sub7.pas4$par[2]-optim.sub7.pas4$par[1]) / (1+exp(1)*((optim.sub7.pas4$par[3]-sub7.pas4$x)/(optim.sub7.pas4$par[4]))))
