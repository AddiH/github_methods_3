...
logLik(m.5.1.pool)
```
> textcolor{}{}When checking our function with the logLik, the same numbers are returned. The difference is that the R-log-likelihood-function returns degrees of freedom which our model does not.
