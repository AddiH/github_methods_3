...
interactions::interact_plot(model = m.subj.sl, pred = "target.frames", modx = "pas") # visualizing the effects of pas and targetframes and their interactions
...
###7.1.i. use the function `optim`. It returns a list that among other things contains the four estimated parameters. 
