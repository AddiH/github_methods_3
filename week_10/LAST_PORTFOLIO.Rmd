...
max_index = np.where(times == 248)[0][0] #The [0] thingeys are to get into the nr. not just 
max_index
...
>expect it will! cuz look at the time dim, that didn't get effected by 
